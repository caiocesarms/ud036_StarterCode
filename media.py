...
class Video():
    """Essa classe permite armazenar informacoes sobre videos, servindo de base
       para outras classes relacionadas"""
...
class Movie(Video):
    ...
    # Esse metodo abre uma pagina web usandoa url do trailer fornecida pelo
    # objeto do filme
